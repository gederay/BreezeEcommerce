    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mx-auto w-full max-w-[550px] bg-white">
                <form class="py-6 px-9" action="{{ route('admin.products.update', $product->slug) }}" method="POST"
                    ...
                    <div class="mb-5">
                        ...
                        <x-text-input id="title" class="block mt-2 w-full" type="text" name="title"
                            :value="old('title', $product->title)" autocomplete="title" />
                        <x-input-error :messages="$errors->get('title')" class="mt-2" />
                    </div>

                    <div class="mb-5">
                        <x-input-label for="slug" :value="__('Slug')" />
                        <x-text-input id="slug" class="block mt-2 w-full" type="text" name="slug"
