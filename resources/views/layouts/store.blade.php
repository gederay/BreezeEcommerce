    ...
    <div x-bind:class="{'dark' : darkMode === true}">
        <div class="min-h-screen bg-gray-100 dark:bg-gray-700">
            ...
            <nav x-data="{ open: false }"
                class="fixed z-10 w-full top-0 bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            <x-nav-link :href="route('store.home')" :active="request()->routeIs('store.home')">
                                {{ __('Home') }}
                            </x-nav-link>
                            <x-nav-link :href="route('products.index')" :active="request()->routeIs('products.index')">
                                {{ __('Products') }}
                            </x-nav-link>
                            <x-nav-link :href="route('store.contacts')" :active="request()->routeIs('store.contacts')">
                                {{ __('Contact') }}
                            </x-nav-link>
                        </div>
                        ...
                        <div x-data="{
                            ...
                            <div class="flex items-center justify-center mr-5 cursor-pointer">
                                <div class="relative scale-75">
                                    <a href="{{ route('cart.index') }}">
                                        ...
                                        <small x-show="cartItemsCount" x-text="cartItemsCount"
                                            class="absolute -top-2 left-4 rounded-full bg-red-500 p-0.5 px-2 text-sm text-red-50"></small>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="hidden sm:flex sm:items-center sm:ml-6">
                                ...
                                <div class="">
                                    ...
                                    @else
                                    <a href="{{ route('login') }}"
                                        class="text-sm text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Log
                                        in</a>

                                    @if (Route::has('register'))
                                    <a href="{{ route('register') }}"
                                        class="ml-4 text-sm text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Register</a>
                                    @endif
                                    @endauth
                                </div>
                                @endif
                ...
                <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <x-responsive-nav-link :href="route('store.contacts')"
                            :active="request()->routeIs('store.contacts')">
                            {{ __('Contact') }}
                        </x-responsive-nav-link>
                    </div>
